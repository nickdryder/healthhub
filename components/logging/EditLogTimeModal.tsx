...
interface EditLogTimeModalProps {
  visible: boolean;
  logId: string;
  currentTime: string;
  logType: string;
...
export function EditLogTimeModal({
  visible,
  logId,
  currentTime,
  logType,
  ...
  const handleSave = async () => {
    try {
      ...
      Alert.alert('Error', 'Failed to update log time');
      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <View style={styles.entryInfo}>
            <Text style={styles.infoLabel}>{logType}</Text>
            <Text style={styles.infoValue}>{logValue}</Text>
          </View>
